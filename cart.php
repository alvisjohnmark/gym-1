...
<body>
  ...
  <div class="container">
    ...
    <div class="user-profile">
      ...
      <div class="flex">
        <a href="./forms/login.php" class="btn">login</a>
        <a href="./forms/signup.php" class="option-btn">register</a>
        <a href="./forms/login.php?logout=<?php echo $user_id; ?>"
    ...
    <div class="shopping-cart">
      ...
      <div class="cart-btn">
        <a href="./cart.php?update_stock" onclick="return confirm('purchase all from cart?');"
          class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">proceed
          to
          checkout</a>
